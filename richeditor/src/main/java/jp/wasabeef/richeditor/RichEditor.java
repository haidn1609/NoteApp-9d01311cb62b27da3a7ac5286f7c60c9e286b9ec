...
public class RichEditor extends WebView {
    ...
    public void insertTodoDownLine() {
        exec("javascript:RE.setTodoDownLine('" + Utils.getCurrentTime() + "');");
    }

    public void insertSubTodo() {
        exec("javascript:RE.setSubTodo('" + Utils.getCurrentTime() + "');");
    }
